...
const Contact = () => {
  ...
  return (
    <>
      <section className="relative  font-ralewayR overflow-hidden bg-gray-200 md:py-20  md:px-10 lg:px-20  dark:bg-dark lg:py-[120px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="mb-9 text-base leading-relaxed dark:text-dark-6">
                  Have questions about our diagnostic services, need help
                  booking a test, or want to learn more about our health
                  packages? The team at Olek Diagnostic Center is here to
                  support you. Whether it's routine blood work, full-body
                  checkups, or corporate wellness programs — we’re just a call
                  or message away. Reach out through the form below or connect
                  with us directly, and we’ll respond promptly.
                </p>
